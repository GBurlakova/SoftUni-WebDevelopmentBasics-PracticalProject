<form action="/photo-album/admin/editPhotoComment"  method="post" class="form-horizontal">
    ...
    <button class="btn-sm btn-default">
        <a href="/photo-album/admin/photos/<?php $this->renderText($this->albumId); ?>">Cancel</a>
    </button>
</form>